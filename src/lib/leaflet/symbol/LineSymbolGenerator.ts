...
import type { ExtendedLineSymbologyOptions } from '$lib/leaflet/types';

export class LineSymbolGenerator {
	static generate(options: ExtendedLineSymbologyOptions): string {
	...
	static createStyle(options: ExtendedLineSymbologyOptions): L.PathOptions {
	...
	private static getLinePattern(options: ExtendedLineSymbologyOptions): string {
	...
	private static createArrowhead(options: ExtendedLineSymbologyOptions): string {
