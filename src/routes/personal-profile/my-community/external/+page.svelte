<script lang="ts">
	...
	let stayInTouchChoices = $state(
		data.userProfile.community_external_profile?.stay_in_touch_choices
	);
	...
	function handleReset() {
		if (confirm('Are you sure you want to undo? All unsaved changes will be lost.')) {
			...
			otherComments = data.userProfile.community_external_profile?.other_comments;
			stayInTouchChoices = data.userProfile.community_external_profile?.stay_in_touch_choices;
